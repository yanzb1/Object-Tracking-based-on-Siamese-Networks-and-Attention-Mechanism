...
__C.TRAIN.EXEMPLAR_SIZE = 135

__C.TRAIN.SEARCH_SIZE = 263
...
__C.DATASET.NAMES = ( 'VID', 'YOUTUBEBB', 'COCO', 'DET', 'GOT10K', 'LASOT')
...
__C.DATASET.YOUTUBEBB.ROOT = '/media/sci/移动硬盘/youbb/ytb-crop511/crop511'
__C.DATASET.YOUTUBEBB.ANNO = '/media/sci/移动硬盘/youbb/ytb-crop511/train.json'
__C.DATASET.YOUTUBEBB.FRAME_RANGE = 3
__C.DATASET.YOUTUBEBB.NUM_USE = 200000
#
__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = '/media/sci/移动硬盘/coco/crop511'
__C.DATASET.COCO.ANNO = '/media/sci/移动硬盘/coco/train2017.json'
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = 100000
#
__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = '/home/sci/det/crop511'
__C.DATASET.DET.ANNO = '/home/sci/det/train.json'
__C.DATASET.DET.FRAME_RANGE = 1
__C.DATASET.DET.NUM_USE = 200000
#
__C.DATASET.GOT10K = CN()
#__C.DATASET.GOT10K.ROOT = 'training_dataset/GOT-10k/crop511'
__C.DATASET.GOT10K.ROOT = '/home/sci/got10k/crop511'
__C.DATASET.GOT10K.ANNO = '/home/sci/got10k/train.json'
__C.DATASET.GOT10K.FRAME_RANGE = 100
__C.DATASET.GOT10K.NUM_USE = 200000

__C.DATASET.LASOT = CN()
__C.DATASET.LASOT.ROOT = '/home/sci/lasot/crop511'
__C.DATASET.LASOT.ANNO = '/home/sci/lasot/train.json'
...
# BAN type
__C.BAN.TYPE = 'FCOSOcean'

__C.BAN.KWARGS = CN(new_allowed=True)
__C.FEATUREFUSION = CN()
__C.FEATUREFUSION.KWARGS = CN(new_allowed=True)
# ------------------------------------------------------------------------ #
# Point options
# ------------------------------------------------------------------------ #
__C.POINT = CN()
...
__C.TRACK.TYPE = 'Tracker'

# Scale penalty
__C.TRACK.PENALTY_K = 0.0
